...
public class ChatController {
    ...
    public void initialize() {
        ...
        this.chatService = new ChatService(new ChatRepository(), new ContactRepository());
    ...
    private void setupListViews() {
        chatListView.setCellFactory(param -> new ListCell<>() {
            ...
            protected void updateItem(Chat chat, boolean empty) {
                ...
                if (empty || chat == null) {
                    ...
                    setText(chat.isGroupChat() ? chat.groupName() : "Private Chat ID: " + chat.id());
                }
            }
        });
        ...
        chatListView.getSelectionModel().selectedItemProperty().addListener((obs, oldChat, newChat) -> {
            if (newChat != null) {
                ...
                currentChatLabel.setText(newChat.isGroupChat() ? newChat.groupName() : "Private Chat");
    ...
    private void handleSend() {
        ...
        if (!text.isEmpty() && currentChat != null) {
            App.cometClient.sendChatMessage(currentChat.id(), currentUser.id(), text);
            messageField.clear();
    ...
    private void appendMessageToUI(Message msg) {
        String senderName = msg.senderId().equals(currentUser.id()) ? "You" : "User " + msg.senderId();
